...
\author[Group Project]{敖婧妍，李赫轩，田润泽，王胤博，肖俊佳}
\institute[Regression Analysis]{School of Statistics }
\date{\today}
...
\begin{frame}{Phase V: Weighted Least Squares (WLS)}
    ...
    \begin{columns}
        \column{0.5\textwidth}
        \centering
        \includegraphics[width=0.8\linewidth]{r_wls_pred_vs_act_v1.png}
