...
\begin{itemize}
    ...
    \item The \textbf{Weighted $R^2 = 0.763$} measures how well the model captures core musical trends in the training data, not test-set predictive power.
\end{itemize}
...
While the model captures musical evolution (Weighted $R^2 = 0.763$), practical prediction accuracy is characterized by \textbf{MAE $\approx$ 9.31 years} on the test set. Large prediction errors are often informative. We define the \textbf{Nostalgia Index} as:
